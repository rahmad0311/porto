      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              ...
              <div className="text-lg md:text-xl text-gray-300 font-light">
                ...
                <span className="text-gray-500 mx-2">|</span>
                <span className="text-cyan-400">Ilustrator</span>
                <span className="text-gray-500 mx-2">|</span>
                <span className="text-green-400">Content Creator</span>
              </div>
            </div>
            
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl leading-relaxed">
              Menggabungkan teknologi, strategi pemasaran digital, dan kreativitas untuk menciptakan solusi 
              inovatif yang menghasilkan dampak nyata. Spesialis dalam pengembangan web, kampanye digital, 
              ilustrasi, dan konten multimedia yang engaging.
            </p>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-full max-w-2xl h-[500px] lg:h-[700px] rounded-2xl overflow-hidden border border-purple-500/20 shadow-2xl shadow-purple-500/10">
              <spline-viewer 
