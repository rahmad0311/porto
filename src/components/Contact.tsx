  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "rahmad@email.com",
      link: "mailto:rahmad@email.com"
    },
    {
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Siap mengembangkan proyek digital yang impactful? Mari diskusikan bagaimana teknologi, 
            strategi marketing, dan kreativitas dapat mengangkat bisnis Anda!
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-purple-900/50 to-cyan-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                Dari pengembangan aplikasi web hingga strategi digital marketing yang komprehensif, 
                saya siap membantu mewujudkan visi digital Anda dengan pendekatan yang holistik dan 
                hasil yang terukur.
              </p>
            </div>
          </div>
